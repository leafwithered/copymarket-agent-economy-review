...
const SERVICE = process.env.BUYER_SERVICE ?? 'copyrescue'
...
const ARGS = (
  process.env.BUYER_ARGS ||
  process.env.BUYER_ARG ||
  'crypto wallet landing page needs a clearer hero and trust path'
